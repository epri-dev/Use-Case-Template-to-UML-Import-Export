...
-->
	<xsl:template name="CommaDelimValue">
		...
		<xsl:variable name="ContentsA">
			<xsl:call-template name="FindAndParseTable">
				<xsl:with-param name="TableIdentifier" select="$TableIdentifier"/>
		...
		<xsl:variable name="Contents">
			<xsl:value-of select="substring-after(substring-before($ContentsA,'&lt;/name&gt;'),'&lt;name&gt;')"/>
		</xsl:variable>
		<xsl:choose>
